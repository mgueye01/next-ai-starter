      ...
      <div className="max-w-4xl mx-auto px-4 py-32">
        ...
        <div className="prose prose-lg max-w-none text-elgato-brown">
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Qu'est-ce qu'un cookie ?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Les cookies que nous utilisons</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Ce que nous n'utilisons PAS</h2>
            <p className="text-elgato-text-light">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Gestion des cookies</h2>
            <p className="text-elgato-text-light mb-4">
