    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-[#ECEEDF]/30 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-[#6B5B47] mb-6 tracking-tight">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-[#BBDCE5]/10 to-[#CFAB8D]/10 rounded-2xl p-8">
              <h2 className="text-2xl font-light text-[#6B5B47] mb-4">
                Transparence Totale
              </h2>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-[#ECEEDF]/30">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#BBDCE5] to-[#CFAB8D] text-white px-10 py-5 rounded-full hover:shadow-xl transition-all"
            >
            ...
            <Link
              href="/services"
              className="inline-flex items-center justify-center gap-2 border-2 border-[#CFAB8D] text-[#CFAB8D] px-10 py-5 rounded-full hover:bg-[#CFAB8D] hover:text-white transition-all"
            >
              Voir les services
            </Link>
          </div>
