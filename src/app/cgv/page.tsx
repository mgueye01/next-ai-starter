      ...
      <div className="max-w-4xl mx-auto px-4 py-32">
        ...
        <div className="prose prose-lg max-w-none text-[#6B5B47]">
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">1. Champ d'application</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">2. Devis et réservation</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">3. Tarifs</h2>
            <p className="text-[#8B7355]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">4. Paiement</h2>
            <p className="text-[#8B7355] mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">5. Annulation</h2>
            <p className="text-[#8B7355] mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">6. Livraison</h2>
            <p className="text-[#8B7355]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">7. Droits d'auteur</h2>
            <p className="text-[#8B7355]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-[#6B5B47] mb-4">8. Droit à l'image</h2>
            <p className="text-[#8B7355]">
