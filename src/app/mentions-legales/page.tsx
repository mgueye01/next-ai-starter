      ...
      <div className="max-w-4xl mx-auto px-4 py-32">
        ...
        <div className="prose prose-lg max-w-none text-elgato-brown">
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Éditeur du site</h2>
            <p className="text-elgato-text-light">
              <strong>elGato Photo Paris</strong><br />
              Photographe professionnel<br />
              SIRET: 852 165 786 00017<br />
              Paris, France<br />
              Email: contact@elgatophoto.com<br />
              Téléphone: +33 6 77 68 48 36
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Hébergement</h2>
            <p className="text-elgato-text-light">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Propriété intellectuelle</h2>
            <p className="text-elgato-text-light">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Droit à l'image</h2>
            <p className="text-elgato-text-light">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-medium text-elgato-brown mb-4">Collecte de données</h2>
            <p className="text-elgato-text-light">
