...
export default function TestimonialsCTA() {
  return (
    <section className="py-20 md:py-24 bg-gradient-to-b from-white to-[#ECEEDF]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* CTA Section */}
        <motion.div
          className="bg-gradient-to-br from-[#BBDCE5]/20 to-[#CFAB8D]/20 rounded-3xl p-8 md:p-12 text-center"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-lg text-[#8B7355] mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-3 bg-gradient-to-r from-[#BBDCE5] to-[#CFAB8D] text-white hover:from-[#A5C9D4] hover:to-[#B89B7F] rounded-full px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Me Contacter
            ...
            <Link
              href="/portfolio"
              className="group inline-flex items-center gap-2 text-[#6B5B47] hover:text-[#8B7355] font-medium transition-colors duration-300"
            >
              Voir mon Portfolio
