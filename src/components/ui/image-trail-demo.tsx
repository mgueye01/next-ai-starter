...
const ImageTrailDemo = () => {
 ...
 const images = [
  ...
  return (
    <div className="flex w-full h-screen justify-center items-center bg-white dark:bg-neutral-900 relative overflow-hidden">
      ...
      <h1 className="text-7xl md:text-9xl font-bold z-10 select-none bg-clip-text text-transparent bg-gradient-to-r from-neutral-950 to-neutral-500 dark:from-neutral-50 dark:to-neutral-500">
        ALBUMS
      </h1>
    </div>
  )
