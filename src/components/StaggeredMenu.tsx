  ...
  return (
    <div className="sm-scope w-full h-full pointer-events-none">
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute left-0 w-full flex items-center justify-between bg-transparent pointer-events-none z-20"
          aria-label="Main navigation header"
          style={{
            top: '-2rem',
            paddingTop: 'calc(2rem + 1em)',
            paddingBottom: '1em',
            paddingLeft: '2em',
            paddingRight: '2em',
